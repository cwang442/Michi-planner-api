...
const server = http.createServer(async (req, res) => {
  ...
  if (req.method === "POST" && req.url === "/scan") {
    ...
    const prompt = `Collectr app screenshot. List every card visible, left to right, top to bottom.
Return ONLY a JSON array, no markdown, no explanation:
[{"name":"","set":"","rarity":"","price":""}]
Rarity options: Illustration Rare, Special Illustration Rare, Art Rare, Ultra Rare, Hyper Rare, Promo, Rare.
Price is CAD number string. Empty string if not visible.`;
